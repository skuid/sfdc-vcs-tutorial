...
wget -q -O ${install_path}/force https://github.com/heroku/force/releases/download/v0.22.72/force_darwin_amd64
chmod +x ${install_path}/force
echo "Downloading and installing the Skuid CLI (https://github.com/skuid/skuid)..."
wget -q -O ${install_path}/skuid https://github.com/skuid/skuid/releases/download/0.1.1/skuid_darwin_amd64
